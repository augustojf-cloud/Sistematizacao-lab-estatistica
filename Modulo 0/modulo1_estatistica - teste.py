...
import pandas as pd
import os  # Biblioteca de aminhos de arquivos e pastas
...
# -------------------------------------------------------
# arquivo: statslocal.py
# arquivo: test_stats.py

statslocal.py #as funções estatíticas e aritmeticas do módulo 1
test_stats.py #os testes das funções do módulo 1

import statslocal as stats

#supondo que 'df' é Dataframe carregado do módulo 0

print ("Média:", stats.media(df"coluna"))
print ("Mediana:", stats.mediana(df"coluna"))
print ("Moda:", stats.moda(df"coluna"))
